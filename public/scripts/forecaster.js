...
const addInputBtn = select('.add');
const calculateBtn = select('.calculate');
const addNewSecBtn = select('.addNewSecBtn');
const addNewSecInp = select('.addNewSecInp');
const yesBtn = select('.yesBtn');
const noBtn = select('.noBtn');
const submitBtn = select('.submitBtn');
const addInput = select('.numAdd');
const userName = select('#name');
const years = select('#years');
const undo = select('.undo');
const creditUnits = selectAll('.creditUnit');
const grades = selectAll('.grade');
const courseCodeInputs = selectAll('.courseCode');
let totalUnit = select('.totalUnit');
let gpaValue = select('.gpaScore');
const level = select('.level');
const semester = select('.semester');
let displayResult = select('.displayResult');
let cgpaScore = select('.cgpaScore');
let displayBg = select('.modalResult-bg');
...
function gpaResult() {
  ...
  let totalUnit = select('.totalUnit');
  let gpaValue = select('.gpaScore');
  let error = select('.error');

  let resultContinue = select('.resultContinue');
...
function addNewInput() {
  const displayOutput = select('.display__output'); // selecting the table body
  const addInput = select('.numAdd').value; // indicating the number of rows to be added
